...
const AboutMe = () => {
  return (
    <div className="h-screen w-screen bg-cover bg-top flex flex-col"
     style={{ backgroundImage: "url('/images/background_2.png')" }}>
        <div className='w-full flex text-xl pt-15 justify-center' id="othertext">
            About Me
        </div>
        <div className='flex flex-col gap-y-5 xl:flex-row xl:mx-15 mt-10'>
            ...
            <div class="flex-1 bg-neutral-300 mx-5 pb-5 mb-5 rounded-sm">
